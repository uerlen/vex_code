...
motor MotorRF = motor(PORT7, ratio18_1, true);
motor MotorRM = motor(PORT22, ratio18_1, true);
motor MotorRB = motor(PORT18, ratio18_1, true);
// motor MotorGet1 = motor(PORT8,ratio18_1, false);
motor MotorGet2 = motor(PORT10, ratio18_1, false);
motor MotorShot1 = motor(PORT8, ratio18_1,false );
motor MotorShot2 = motor(PORT9, ratio18_1, true);
